        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Constituencies_Governorates_GovernorateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Elections_Admins_CreatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Voters_Governorates_GovernorateId",
                        column: x => x.GovernorateId,
                        principalTable: "Governorates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanDecrypt = table.Column<bool>(type: "bit", nullable: false),
                    AssignedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectionOrganizers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElectionOrganizers_Admins_AssignedByAdminId",
                        column: x => x.AssignedByAdminId,
                        principalTable: "Admins",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ElectionOrganizers_Elections_ElectionId",
                        column: x => x.ElectionId,
                        principalTable: "Elections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ElectionOrganizers_Organizers_OrganizerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountedByOrganizerId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Results_Organizers_CountedByOrganizerId",
                        column: x => x.CountedByOrganizerId,
                        principalTable: "Organizers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ElectionId = table.Column<int>(type: "int", nullable: false),
                    ElectionVoterId = table.Column<int>(type: "int", nullable: true),
                    EncryptedVote = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ballots_ElectionVoters_ElectionVoterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ElectionVoterId = table.Column<int>(type: "int", nullable: false),
                    Token = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FaceVerified = table.Column<bool>(type: "bit", nullable: false),
                    FaceVerifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VotingSessions_ElectionVoters_ElectionVoterId",
                        column: x => x.ElectionVoterId,
                        principalTable: "ElectionVoters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ballots_ElectionVoterId",
                table: "Ballots",
                column: "ElectionVoterId",
                unique: true,
                filter: "[ElectionVoterId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Constituencies_GovernorateId",
                table: "Constituencies",
                column: "GovernorateId");

            migrationBuilder.CreateIndex(
                name: "IX_ElectionOrganizers_AssignedByAdminId",
                table: "ElectionOrganizers",
                column: "AssignedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_ElectionOrganizers_ElectionId_OrganizerId",
                table: "ElectionOrganizers",
                columns: new[] { "ElectionId", "OrganizerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ElectionOrganizers_OrganizerId",
                table: "ElectionOrganizers",
                column: "OrganizerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectionVoters_ElectionId_VoterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Results_CountedByOrganizerId",
                table: "Results",
                column: "CountedByOrganizerId");

            migrationBuilder.CreateIndex(
                name: "IX_Results_ElectionId_CandidateId",
                table: "Results",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Voters_GovernorateId",
                table: "Voters",
                column: "GovernorateId");

            migrationBuilder.CreateIndex(
                name: "IX_Voters_UniqueIdentifier",
                table: "Voters",
                column: "UniqueIdentifier",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VotingSessions_ElectionVoterId",
                table: "VotingSessions",
                column: "ElectionVoterId");

            migrationBuilder.CreateIndex(
                name: "IX_VotingSessions_Token",
                table: "VotingSessions",
                column: "Token",
                unique: true);
        }
